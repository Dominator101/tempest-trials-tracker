app.factory('trialData',function($rootScope) {
	var trialName = 'Loki\'s Flames' ;
	$rootScope.title = 'Tempest Trials: \'' + trialName + '\' Progress Tracker' ;
	var startDate = new Date(Date.UTC(2018, 4, 25, 7, 00)) ;
	var endDate = new Date(Date.UTC(2018, 5, 4, 6, 59)) ;

	// Character prizes
	var charName = 'Groom Marth' ;

	// Seal Prizes
	var sealName1 = 'Attack/Defense+' ;
	var sealName2 = 'Speed Smoke' ;
